...
class MDConv(nn.Module):
    """
    MDConv class implements a module to automatically set kernel size for dynamic depthwise convolution

    Args:
    - out_chan (int): Number of output channels.
    - n_chunks (int): Number of input channels
    - stride (int): Stride value for the convolution operation.
    - bias (bool): If True, adds a learnable bias to the output.
    """
    def __init__(self, out_chan, n_chunks, stride, bias):
